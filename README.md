...
| Gemma (7B)      | 3m		          | Google Gemma 2 is a high-performing and efficient model | [Gemma (7b)](https://github.com/unaveragetech/Gitbot/issues/30) | pass        |
| Starling        | 2m:50s		|Starling is a large language model trained by reinforcement learning| [Starling) ](https://github.com/unaveragetech/Gitbot/issues/31) | pass        |
